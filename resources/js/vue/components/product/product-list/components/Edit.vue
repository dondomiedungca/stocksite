            ...
            <div>
                <v-row class="form-row">
                    ...
                    <v-col lg="4" md="4" sm="6" xs="12">
                        <v-select outlined :items="statuses" v-model="forEdit.inventory_status_id" label="Inventory Status" dense></v-select>
                    </v-col>
                    <v-col lg="4" md="4" sm="6" xs="12">
                        <v-select outlined :items="cosmetics" v-model="forEdit.inventory_cosmetic_id" label="Item Cosmetic" dense></v-select>
                    </v-col>
                    <v-col lg="4" md="4" sm="6" xs="12">
...
export default {
    ...
    methods: {
        ...mapActions("product_list", ["patchData"]),
        updateItem: function() {
            this.$v.$touch()
            if (!this.$v.$invalid) {
                var self = this
                self.patchData(self.forEdit)
            }
        },
